<template>
     <div>
      <breadcrumb active_name="Dashboard"></breadcrumb>
                    ...
                    <div class="media">
                      <div class="media-body">
                        <div class="greeting-user">
                          <h1>Hello, {{this.$auth_user.name}}</h1>
                          <p>Welcome back, your dashboard is ready!</p><a class="btn btn-outline-white_color" href="blog-single-1.html">Get Started<i class="icon-arrow-right">                           </i></a>
                        </div>
                      </div>
                    </div>
                    <div class="cartoon-img"><img class="img-fluid" src="assets/images/images-1.svg" alt=""></div>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 dash-xl-50">
                <div class="card pb-0 o-hidden earning-card">
                  ...
                  <div class="card-body p-0">
                    <div class="earning-content"><img class="img-fluid" src="assets/images/avatar-1.jpg" alt=""><a href="blog-single-1.html">
                    ...
                    <div class="table-responsive custom-scrollbar">
                      <table class="table table-bordernone">
                        <tbody>
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="assets/images/dashboard/rectangle-26-1.jpg" alt="">
                                <div class="media-body"><a href="blog-single-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media"> <img class="img-fluid me-3 b-r-5" src="assets/images/dashboard/rectangle-27-1.jpg" alt="">
                                <div class="media-body"><a href="blog-single-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="assets/images/dashboard/rectangle-28-1.jpg" alt="">
                                <div class="media-body"><a href="blog-single-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="assets/images/dashboard/rectangle-29-1.jpg" alt="">
                                <div class="media-body"><a href="blog-single-1.html">
                      ...
                      <table class="table table-bordernone">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="assets/images/avtar/boy-1.png" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="assets/images/avtar/girl-1.png" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="assets/images/avtar/man-1.png" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="assets/images/avtar/woman-1.png" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page-1.html">
                                      <h6>Gary</h6></a><span> UK Desig Team</span></div>
                                </div>
                      ...
                      <table class="table table-bordernone">
                        <tbody>
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="assets/images/avtar/teacher-1.png" alt=""></div>
                                <div class="media-body"><a href="user-profile-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="assets/images/avtar/teenager-1.png" alt=""></div>
                                <div class="media-body"><a href="user-profile-1.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="assets/images/avtar/chinese-1.png" alt=""></div>
                                <div class="media-body image-swipe"><a href="user-profile-1.html">
                                    <h5>Max Simmons attached 2</h5></a>
                                  <p>photos to <span class="font-primary">Food photography Class</span></p>
                                  <div class="my-gallery" itemscope="">
                                    <div class="row gallery">
                                      <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a href="assets/images/dashboard/img-26-1.jpg" itemprop="contentUrl" data-size="600x600"><img class="img-fluid img-40" src="assets/images/dashboard/img-26-1.jpg" itemprop="thumbnail" alt="Image description"></a>
                                        <figcaption itemprop="caption description">Photos 1</figcaption>
                                      </figure>
                                      <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a href="assets/images/dashboard/image-20-1.jpg" itemprop="contentUrl" data-size="600x600"><img class="img-fluid img-40" src="assets/images/dashboard/image-20-1.jpg" itemprop="thumbnail" alt="Image description"></a>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="media report-perfom">
                              ...
                              </div><a class="btn btn-primary" href="blog-single-1.html">New Report</a>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="col-xl-3 col-md-6 dash-xl-50">
                <div class="card bg-primary premium-access">
                  <div class="card-body">
                    ...
                    <p>We add 20+ new features and update community in your project We add 20+ new features</p><a class="btn btn-outline-white_color" href="blog-single-1.html"> Try now for free</a>
                  </div>
