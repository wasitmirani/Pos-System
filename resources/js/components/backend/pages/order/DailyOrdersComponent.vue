                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                <tr v-for="item in orders.data" :key="item.id">
                                                    ...
                                                    <td>  <span :class="'badge rounded-pill '+ orderStatus(item.order_status_id)">{{item.order_status.name}}</span></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="#"><i class="las la-print text-secondary font-18"></i></a>
