...
<div class="page-header">
    <div class="header-wrapper row m-0">
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index-1.html">
            <img class="img-fluid" src="{{asset('/assets/images/logo/logo-1.png')}}" alt=""></a>
        </div>
        ...
        <ul class="nav-menus">
          ...
          <li class="cart-nav onhover-dropdown">
            ...
            <div class="cart-dropdown onhover-show-div">
              <div class="dropdown-title">
                <h3>Cart  </h3><a class="f-right" href="cart-1.html"> <i data-feather="shopping-bag">                </i></a>
              </div>
              <ul class="custom-scrollbar">
                <li>
                  <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="../assets/images/banner-1-1.jpg" alt="">
                    <div class="media-body">
                      <h5> <a href="product-1.html">Black shirt with jecket</a></h5>
                ...
                <li>
                  <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="../assets/images/product-4-1.png" alt="">
                    <div class="media-body">
                      <h5> <a href="product-1.html">Yellow white shirt.</a></h5>
                      <p class="f-w-700">$500</p>
                      <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                        <input class="count" type="text" name="qty" value="3"><span class="minus"><i class="fa fa-minus"></i></span>
                      </div>
                ...
                <li>
                  <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="../assets/images/product-6-1.jpg" alt="">
                    <div class="media-body">
                      <h5> <a href="product-1.html">Nike Black shoes !</a></h5>
                      <p class="f-w-700">$500</p>
                      <div class="cart-quantity"> <span class="plus"><i class="fa fa-plus"></i></span>
                        <input class="count" type="text" name="qty" value="3"><span class="minus"><i class="fa fa-minus"></i></span>
                      </div>
                ...
                <li class="order-total">
                  <h4 class="mb-0 f-w-700">Total : <span>$100.00</span></h4><a class="btn btn-primary view-checkout" href="checkout-1.html">Checkout</a>
                </li>
              </ul>
            </div>
          </li>
                        ...
                        <div class="row">
                          <div class="col-4 text-center">
                            <div class="bookmark-content">
                              ...
                              <h5 class="mt-2"> <a href="base-input-1.html">Forms</a></h5>
                            </div>
                          </div>
                          <div class="col-4 text-center">
                            <div class="bookmark-content">
                              <div class="bookmark-icon"><i data-feather="user"></i></div>
                              <h5 class="mt-2"> <a href="user-profile-1.html">Profile</a></h5>
                            </div>
                          </div>
                          <div class="col-4 text-center">
                            <div class="bookmark-content">
                              <div class="bookmark-icon"><i data-feather="server"></i></div>
                              <h5 class="mt-2"> <a href="datatable-basic-init-1.html">Tables</a></h5>
                            </div>
                          </div>
                        </div>
                      </li>
          ...
          <li class="onhover-dropdown">
            ...
            <div class="onhover-show-div notification-dropdown">
              <div class="dropdown-title">
                <h3>Notification</h3><a class="f-right" href="cart-1.html"> <i data-feather="bell">                           </i></a>
              </div>
              <ul class="custom-scrollbar">
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-primary"><img src="../assets/images/avtar/man-1.png" alt=""></div>
                    <div class="media-body">
                      <h5> <a class="f-14 m-0" href="user-profile-1.html">Allie Grater</a></h5>
                ...
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-secondary"><img src="../assets/images/avtar/teacher-1.png" alt=""></div>
                    <div class="media-body">
                      <h5> <a class="f-14 m-0" href="user-profile-1.html">Olive Yew</a></h5>
                ...
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-info"><img src="../assets/images/avtar/teenager-1.png" alt=""></div>
                    <div class="media-body">
                      <h5> <a class="f-14 m-0" href="user-profile-1.html">Peg Legge</a></h5>
                ...
                <li>
                  <div class="media">
                    <div class="notification-img bg-light-success"><img src="../assets/images/avtar/chinese-1.png" alt=""></div>
                    <div class="media-body">
                      <h5> <a class="f-14 m-0" href="user-profile-1.html">Teri Dactyl</a></h5>
          ...
          <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li><a href="user-profile-1.html"><i data-feather="user"></i><span>Account </span></a></li>
              <li><a href="email-application-1.html"><i data-feather="mail"></i><span>Inbox</span></a></li>
              <li><a href="kanban-1.html"><i data-feather="file-text"></i><span>Taskboard</span></a></li>
              <li><a href="edit-profile-1.html"><i data-feather="settings"></i><span>Settings</span></a></li>
              <li><a href="login-1.html"><i data-feather="log-in"> </i><span>Log in</span></a></li>
            </ul>
          </li>
        </ul>
      </div>
      <script class="result-template" type="text/x-handlebars-template">
        ...
        <div class="ProfileCard-realName">{{config('app.name')}}</div>
        </div>
        </div>
      </script>
